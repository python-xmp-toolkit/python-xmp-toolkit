...
class TestExempi(unittest.TestCase):
    ...
    def test_write_new_property(self):
        ...
        the_prop, _ = exempi.get_property_date(xmp,
                                               NS_EXIF,
                                               "DateTimeOriginal")
    ...
    def test_xmp_files(self):
        ...
        info = exempi.files_get_file_info(xfptr)
        file_path, options, file_format, flags = info
...
class TestIteration(unittest.TestCase):
    ...
    def test_single_namespace_single_path_leaf_nodes(self):
        ...
        options = XMP_ITERATOR_OPTIONS['iter_justleafnodes']
        schemas, paths, props = self.collect_iteration(NS_DC,
                                                       "rights",
                                                       options)
